...
function mathJax_init()
{
	setTimeout(function () {
		...
		script.src  = "https://cdnjs.cloudflare.com/ajax/libs/mathjax/2.7.4/MathJax.js?config=MML_HTMLorMML-full"; //TeX-AMS-MML_SVG-full
...
{
	$('thead>tr:not(:last-of-type)>th[data-rowsep="1"]').each(function()
	{
